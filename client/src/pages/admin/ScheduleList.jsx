            ...
            {loading ? (
              ...
              <TableRow key={sc._id}>
                ...
                <TableCell align="right">
                  <IconButton onClick={() => navigate(`/admin/schedules/${sc._id}`)}><VisibilityIcon /></IconButton>
                  <IconButton onClick={() => navigate(`/admin/schedules/edit/${sc._id}`)}><EditIcon /></IconButton>
